...
import io.client.mqttv3.internal.DisconnectedMessageBuffer;
import io.client.mqttv3.internal.SystemHighResolutionTimer;
...
import io.client.mqttv3.internal.ConnectActionListener;
import io.client.mqttv3.internal.ExceptionHelper;
import io.client.mqttv3.internal.HighResolutionTimer;
import io.client.mqttv3.internal.NetworkModule;
import io.client.mqttv3.internal.NetworkModuleService;
...
public class MqttAsyncClient implements IMqttAsyncClient {
	...
	public void sendCustomerMessage( byte[] payload,int qos, boolean retained,IMqttActionListener callback) throws MqttException {
        MqttMessage message = new MqttMessage(payload);
        message.setQos(qos);
        message.setRetained(retained);
        MqttDeliveryToken token = new MqttDeliveryToken(getClientId());
        ...
        comms.sendNoWait(new MqttCustomerMessage((byte)0,qos,payload),token);
//        comms.sendCustomerMessage(message,token);
    }
