...
public abstract class MqttWireMessage {
    public static final byte MESSAGE_TYPE_CONSTOMER = 0;
	...
	private static final String[] PACKET_NAMES = {"CONSTOMER", "CONNECT", "CONNACK", "PUBLISH", "PUBACK", "PUBREC",
	...
	protected abstract byte[] getVariableHeader() throws MqttException, IOException;
	...
	private static MqttWireMessage createWireMessage(InputStream inputStream) throws MqttException {
		try {
			...
			if(type == MqttWireMessage.MESSAGE_TYPE_CONSTOMER){
                result = new MqttCustomerMessage(info,((info >> 1) & 0x03),data);
            }else if (type == MqttWireMessage.MESSAGE_TYPE_CONNECT) {
