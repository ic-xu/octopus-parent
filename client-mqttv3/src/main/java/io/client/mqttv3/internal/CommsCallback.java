...
import io.client.mqttv3.IMqttActionListener;
import io.client.mqttv3.IMqttMessageListener;
import io.client.mqttv3.MqttCallback;
import io.client.mqttv3.MqttCallbackExtended;
import io.client.mqttv3.MqttDeliveryToken;
import io.client.mqttv3.MqttException;
import io.client.mqttv3.MqttMessage;
import io.client.mqttv3.MqttToken;
import io.client.mqttv3.MqttTopic;
import io.client.mqttv3.internal.wire.MqttPubAck;
import io.client.mqttv3.internal.wire.MqttPubComp;
import io.client.mqttv3.internal.wire.MqttPublish;
import io.client.mqttv3.internal.wire.MqttWireMessage;
...
public class CommsCallback implements Runnable {
    ...
    public boolean isRunning() {
        boolean result;
        synchronized (lifecycle) {
            result = ((currentState == State.RUNNING || currentState == State.QUIESCING)
                    && targetState == State.RUNNING);
        }
        return result;
    }
    ...
    public boolean isQuiescing() {
        boolean result;
        synchronized (lifecycle) {
            result = (currentState == State.QUIESCING);
        }
        return result;
    }
}
