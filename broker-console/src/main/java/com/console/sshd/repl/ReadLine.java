...
public class ReadLine {
    ...
    public String readLine(String prompt, Repel.CommandCompleter completer) {
        try {
    ...
    //
    private String doRead(String prompt, Repel.CommandCompleter completer) throws IOException {
        int b;
        int tabCount = 0;
        print(prompt);
        flush();
