...
public class MqttProtocolUtil {
    ...
    public static MqttCustomerMessage customerMessage(boolean isDup, int qosValue, boolean isRetain, ByteBuf payload, byte messageType) {
    return new MqttCustomerMessage(
            new MqttFixedHeader(MqttMessageType.CUSTOMER, isDup, MqttQoS.valueOf(qosValue), isRetain, 0),
            new MqttCustomerVariableHeader((short)333) ,payload,messageType);
    }
