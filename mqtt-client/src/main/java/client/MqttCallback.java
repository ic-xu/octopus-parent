...
public interface MqttCallback {
    ...
    void customerMessageArrived(MqttCustomerMessage message);
     ...
     * @param remoteAddress The server URI that the connection was made to.
     */
    void connectComplete(boolean reconnect, InetSocketAddress remoteAddress);
     ...
     */
    void deliveryComplete(Object token);
}
