...
import io.octopus.base.subscriptions.{ISubscriptionsDirectory, Topic}
...
class NettyHttpServerHandler(sessions: SessionResistor, subscriptionsDirectory: ISubscriptionsDirectory) extends ChannelInboundHandlerAdapter {
