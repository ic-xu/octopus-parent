...
import io.octopus.broker.subscriptions.{ISubscriptionsDirectory, Topic}
...
class UdpMQTTHandler(sessionRegistry: SessionRegistry, subscriptionsDirectory: ISubscriptionsDirectory) extends SimpleChannelInboundHandler[DatagramPacket] {
