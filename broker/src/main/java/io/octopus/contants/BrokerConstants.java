...
public interface BrokerConstants {
    ...
    Integer udpTransportDefaultPort=25522;
    ...
    String redis_use_cluster_servers_address= "redis.use-cluster-servers.address";
    String redis_single_server_config_address="redis.single-server-config.address";
    String redisConfigPath="redis.config-path";
