...
import io.octopus.broker.MqttConnectionFactory;
...
public class NewNettyMQTTHandler extends ChannelInboundHandlerAdapter {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(NewNettyMQTTHandler.class);
...
//        }
    ...
    public void userEventTriggered(ChannelHandlerContext ctx, Object evt) {
        if (evt instanceof InflictReSenderHandler.ResendNotAckedPublishes) {
            final MqttConnection mqttConnection = mqttConnection(ctx.channel());
