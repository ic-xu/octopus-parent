...
public class MQTTMessageLogger extends ChannelDuplexHandler {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MQTTMessageLogger.class);
    ...
    private void logMQTTMessage(ChannelHandlerContext ctx, Object message, String direction) throws Exception {
        ...
        switch (messageType) {
            ...
            case PUBREC:
                ...
                LOGGER.info("{} SUBACK <{}> packetID <{}>, grantedQoses {}", direction, clientID, messageId(msg),
