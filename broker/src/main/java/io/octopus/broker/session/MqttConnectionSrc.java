...
// * message handle core
// */
//public final class MqttConnectionSrc {
//
//    private static final Logger LOGGER = LoggerFactory.getLogger(MqttConnectionSrc.class);
//
...
//
//    public MqttConnectionSrc(Channel channel, BrokerConfiguration brokerConfig, IAuthenticator authenticator,
//                             SessionRegistry sessionRegistry, PostOffice postOffice) {
//        this(channel, brokerConfig, authenticator, sessionRegistry, postOffice, null, null);
//    }
//
//    public MqttConnectionSrc(Channel channel, BrokerConfiguration brokerConfig, IAuthenticator authenticator,
//                             SessionRegistry sessionRegistry, PostOffice postOffice, BrokerNotifyInterceptor interceptor, Authorizator authorizator) {
...
//                    if (result.getMode() == SessionRegistry.CreationModeEnum.REOPEN_EXISTING) {
...
//
//                //刷盘，异步发送
//                postOffice.receivedQos0(topic, username, clientId, msg);
//                break;
//            case AT_LEAST_ONCE:
//
//                //不用刷盘，同步发送
////                postOffice.receivedPublishQos1(this, topic, username, msg);
//
//                //刷盘，异步发送
//                postOffice.receivedQos1(this, topic, username, msg);
//                break;
//
//            case EXACTLY_ONCE:
//                //不用刷盘，同步发送
