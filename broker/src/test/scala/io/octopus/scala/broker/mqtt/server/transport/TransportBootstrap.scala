...
//  private var ports: java.util.Map[String, Integer] = new util.HashMap()
...
//   */
//  def initialize(config: IConfig, postOffice: IPostOffice,
...
//   */
//  def bootstrap(config: IConfig, sessionFactory: ISessionResistor, subscriptionsDirectory: ISubscriptionsDirectory, postOffice: IPostOffice): Unit = {
