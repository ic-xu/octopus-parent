...
/**
 * Check that octopus could also handle SSL with client authentication.
 *
 ...
 *  <pre>
 *  keytool -genkeypair -alias signedtestclient -dname cn=client.octopus.io -validity 10000 -keyalg RSA -keysize 2048 -keystore signedclientkeystore.jks -keypass passw0rd -storepass passw0rd
 *  </pre>
 *
 ...
 *  <pre>
 *  keytool -genkeypair -alias unsignedtestclient -dname cn=unverifiedclient.octopus.io -validity 10000 -keyalg RSA -keysize 2048 -keystore unsignedclientkeystore.jks -keypass passw0rd -storepass passw0rd
 *  </pre>
 ...
 * keytool -genkeypair -alias signedtestserver -dname cn=octopus.eclipse.org -keyalg RSA -keysize 2048 \
 * -keystore signedserverkeystore.jks -keypass passw0rdsrv -storepass passw0rdsrv -validity 10000
 * keytool -genkeypair -alias signedtestserver_sub -dname cn=octopus.eclipse.org -keyalg RSA -keysize 2048 \
 ...
 * keytool -genkeypair -alias signedtestclient -dname cn=octopus.eclipse.org -keyalg RSA -keysize 2048 \
 ...
 * keytool -genkeypair -alias unsignedtestclient -dname cn=octopus.eclipse.org -validity 10000 -keyalg RSA \
...
public class ServerIntegrationSSLClientAuthTest {
    ...
    public static void beforeTests() {
        backup = System.getProperty("octopus.path");
    }

    @AfterClass
    public static void afterTests() {
        if (backup == null)
            System.clearProperty("octopus.path");
        else
            System.setProperty("octopus.path", backup);
    }

    protected void startServer(String dbPath) throws IOException, InterruptedException {
        String file = getClass().getResource("/").getPath();
        System.setProperty("octopus.path", file);
        m_server = new Server();
