...
package io.octopus.spec.v3_1_1.connection;
...
import io.octopus.integration.IntegrationUtils;
import io.octopus.testclient.RawClient;
...
public class ConnectionIT {
    ...
    public void tearDown() {
        ...
        if (dbFile.exists()) {
            assertTrue(
                    "Error deleting the octopus db file " + BrokerConstants.DEFAULT_PERSISTENT_PATH,
                    dbFile.delete());
        }
