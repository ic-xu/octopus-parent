...
import com.octopus.core.Driver;
import com.octopus.core.Jazmin;
import com.octopus.core.Lifecycle;
import com.octopus.core.Registerable;
import com.octopus.core.Server;
import com.octopus.core.app.AutoWiredObject.AutoWiredField;
...
public class Application extends Lifecycle {
    ...
    public <T> T createWired(Class<T> clazz) throws Exception {
        ...
        try {
            ...
            logger.trace("can not create wired object of class " + clazz);
            throw e;
        }
    }
